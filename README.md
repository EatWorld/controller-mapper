...
### v1.1 (2026-06-16)
- 🔧 **修复摇杆映射**: 恢复摇杆→鼠标移动映射功能（左/右摇杆可选）
- 🔧 **扳机键兼容性**: 自动检测手柄轴布局，支持不同型号Xbox/兼容手柄
- 🔧 **扳机键零点校准**: 启动时采样基准值，防止静止漂移误触
- 🔧 **依赖修复**: requirements.txt 补全 mouse、pywin32 等缺失依赖
- 🔧 **代码清理**: 移除过多调试输出，添加版本号管理
